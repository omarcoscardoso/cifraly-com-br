    ...
    <header class="w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            <a href="/" class="flex items-center gap-2 transition hover:opacity-90">
                <x-brand-logo class="h-9 sm:h-11 w-auto text-white" />
            </a>

            <div class="flex items-center gap-3">
                <a href="{{ url('/app/register') }}" class="hidden sm:inline-flex items-center px-3.5 py-1.5 rounded-xl text-sm font-medium text-slate-300 hover:text-white transition">
                    Criar Conta
                </a>
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8 text-center">
        <div class="max-w-2xl mx-auto space-y-8">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2">
                ...
                <a href="{{ url('/app/register') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl text-base font-semibold border border-slate-700 bg-slate-900/80 hover:bg-slate-800 text-white transition transform active:scale-98">
