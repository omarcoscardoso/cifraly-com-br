...
>
    ...
    <nav
        class="fixed bottom-0 inset-x-0 z-40 border-t border-gray-200/80 bg-white/95 backdrop-blur-lg dark:border-stone-800/80 dark:bg-stone-950/95"
    ...
    >
        <div class="relative mx-auto flex h-16 max-w-md items-center justify-around px-2">
            ...
            >
                <svg class="h-6 w-6 {{ $isDashboardActive ? 'stroke-[2.2]' : 'stroke-2' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
                <svg class="h-6 w-6 {{ $isSongsActive ? 'stroke-[2.2]' : 'stroke-2' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
                <svg class="h-6 w-6 {{ $isEventsActive ? 'stroke-[2.2]' : 'stroke-2' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
                <svg class="h-6 w-6 {{ $isProfileActive ? 'stroke-[2.2]' : 'stroke-2' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
